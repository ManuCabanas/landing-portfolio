...
function App() {
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 antialiased" style={{ fontFamily: "'Syne', system-ui, sans-serif" }}>
      ...
      <header className="min-h-[90vh] flex items-center justify-center px-6 py-20 animate-[fadeIn_0.8s_ease-out_forwards]">
        <div className="max-w-4xl mx-auto text-center">
          <img src={manuelImg} alt="Manuel Cabanas" className="w-32 h-32 rounded-full mx-auto mb-6 object-cover" />
          <p className="text-amber-400/80 font-medium tracking-widest uppercase text-sm mb-6">
            Welcome to my portfolio
          </p>
          <h1 className="text-5xl md:text-7xl lg:text-8xl text-zinc-100 mb-8 leading-tight" style={{ fontFamily: "'Instrument Serif', serif" }}>
            Hi, I'm{' '}
          ...
          I’m a Systems Engineering student at Universidad Tecnológica Nacional (FRBA) with hands-on experience building web applications and personal projects.
I focus on developing solutions that meet real client requirements, prioritizing robustness, maintainability, and ease of use.
I’m constantly driven to learn, improve my skills, and grow as a software developer, with a strong interest in building reliable and well-structured products.
          </p>
          <a 
            href="#projects" 
      ...
      <section id="projects" className="px-6 py-24">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 animate-[slideUp_0.8s_ease-out_forwards]">
            <h2 className="text-4xl md:text-5xl text-zinc-100 mb-4" style={{ fontFamily: "'Instrument Serif', serif" }}>
      ...
      <footer className="px-6 py-20 border-t border-zinc-800/50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl text-zinc-100 mb-4" style={{ fontFamily: "'Instrument Serif', serif" }}>
